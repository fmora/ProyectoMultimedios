...
public class RSSAdapter_viaje extends ArrayAdapter<ModelViaje> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		idConductor = holder.getidConductor();
	    ciudadOrigen = holder.getciudadOrigen();
	    ciudadDestino = holder.getciudadDestino();
	    fecha = holder.getfecha();
	    ptoPartida = holder.getptopartida();
	    ptoPartidaGPS = holder.getptoPartidaGPS();
	    ...
	    ptoPartida.setText("Pto Partida: "+model.ptoPartida);
	    ptoPartidaGPS.setText(model.ptoPartidagps);
	    ptoLlegada.setText("Pto Llegada: "+model.ptoLlegada);
	    ptoLlegadaGPS.setText(model.ptoLlegadagps);
		return convertView;
	}
	...
	private class ViewHolder {
	    ...
	    public TextView getptoPartidaGPS(){
